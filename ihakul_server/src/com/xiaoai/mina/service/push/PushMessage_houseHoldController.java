 ...
 * @Description 消息推送
 */
public class PushMessage_houseHoldController {
	private static final Logger logger=Logger.getLogger(PushMessage_houseHoldController.class);
	...
	public static boolean push2Xiao(JSONObject json,HashMap map){
		...
		if(xaSession !=null){ //如果有这个账号 就进行转发
			...
			logger.info("推送的消息(家电控制)是:"+sent.toString());
			return true;
		}
